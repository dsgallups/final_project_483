...
# the evaluation is relative to the opponent, 
# which can be a problem if you have no opponent that's the objective best
# so each AI will play against every other AI.
...
def run_neat(config):
    #p = neat.Checkpointer.restore_checkpoint('neat-checkpoints/neat-checkpoint-27')
